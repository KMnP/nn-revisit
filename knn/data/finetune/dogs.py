...
_DATA_DIR = ""  # need to update this TODO: move this to config
FOLDER = "Stanford-dogs"
...
class DogsDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, split):
        assert split in {
            ...
            "val",
            "test"
        }, "Split '{}' not supported for stanford-dogs dataset".format(split)
        logger.info("Constructing stanford-dogs dataset {}...".format(split))
        self.cfg = cfg
        self._split = split
